...
template<class>
class AngelScriptRelicTestsFixture : public AngelScriptFixture
{
public:
    template<class T>
...
public:
    ...
    CreatedObject<T> CreateObject(Arca::Reliquary& reliquary)
    {
        ...
        const auto materialAssetType = Atmos::Asset::MaterialType::Region;
        const auto materialAssetPasses = std::vector<Atmos::Asset::Material::Pass>
        {
            { vertexShaderAsset, fragmentShaderAsset }
        };
        const auto index = reliquary.Do(Arca::Create<Atmos::Asset::Material>{ materialAssetName, materialAssetType, materialAssetPasses });
        return TupleOf<T>(index);
    }
...
public:
    ...
    CreatedObject<T> CreateObject(Arca::Reliquary& reliquary)
    {
        ...
        const auto materialAsset = reliquary.Do(Arca::Create<Atmos::Asset::Material>{ materialAssetName, materialAssetType, materialAssetPasses });
