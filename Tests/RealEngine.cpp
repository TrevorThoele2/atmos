...
RealEngine::RealEngine(Logging::Logger& logger) :
    Engine(CreateInitializationProperties(logger), Chroma::TypeIdentity<World::RealManager>{}, logger),
    worldManager(dynamic_cast<World::RealManager*>(WorldManager()))
{}

auto RealEngine::CreateInitializationProperties(Logging::Logger& logger) -> InitializationProperties
{
